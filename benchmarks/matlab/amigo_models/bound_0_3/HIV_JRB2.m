...
% %
 ...
 inputs.nlpsol.eSS.log_var =1:10+5;                    % Index of parameters to be considered in log scale
 inputs.nlpsol.eSS.maxeval =80000;                  % Maximum number of cost function evaluations
